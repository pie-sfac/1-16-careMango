  ...
  return (
    <div>
      ...
      <div className="flex justify-between topBar">
        ...
        <div>
          <select name="selectManager" id="manager">
            <option value="">관리자명</option>
          </select>
        </div>
        <div>
          <select name="selectView" id="calendarView">
      ...
      <div className="flex">
        ...
        <div>
          <div>
            <p>02.01(수)</p>
            <ul className="flex">
              <li className="inline-block">총 일정 : 100건</li>
              <li className="inline-block">취소 일정 : 100건</li>
              <li className="inline-block">취소율 : 100%</li>
            </ul>
          </div>
          <ul />
          <table>
